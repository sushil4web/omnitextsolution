    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
      <div class="container">
        <i style="line-height: 2.5"></ul>Copyright &copy; 2015 <a href="index.php">Omni Text Solution</a>. All Rights Reserved.</i>
    ...
    <script src="js/bootstrap.min.js"></script Id="2header">
  </body>
</html>